...
urlpatterns = [
    ...
    path(
        "gastos-adeudados/pdf/<int:vehiculo_id>/",
        views.gastos_adeudados_pdf,
        name="gastos_adeudados_pdf"
    ),
    # ==================================================
    ...
    path(
        "pago-gasto/recibo/<int:pago_id>/",
        views.recibo_gasto_ingreso_pdf,
        name="recibo_gasto_ingreso_pdf"
    ),
    path(
        "<int:vehiculo_id>/recibo-gastos-pagados/",
        views.recibo_gastos_pagados_pdf,
