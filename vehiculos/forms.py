...
class FichaVehicularForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'cedula_archivo': forms.ClearableFileInput(attrs={'class': 'form-control', 'accept': 'image/*,application/pdf'}),
            'patentes_archivo': forms.ClearableFileInput(attrs={'class': 'form-control', 'accept': 'image/*,application/pdf'}),
            'infracciones_archivo': forms.ClearableFileInput(attrs={'class': 'form-control', 'accept': 'image/*,application/pdf'}),
