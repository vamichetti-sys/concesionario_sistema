...
9° - El precio total de la unidad es de {simbolo} {precio_numeros} ({precio_letras} {moneda_texto}), quedando un saldo conforme la siguiente modalidad de pago: {saldo_forma_pago}. El auto ha sido revisado y aceptado en conformidad.-
